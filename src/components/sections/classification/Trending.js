...
const trendingleftposts = [
  {
    ...
    text: "Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.",
    animationtime: ".3s",
  },
  {
    img: img2,
          ...
          <div className="row justify-content-center">
            <div className="col-lg-6 col-md-10">
              {trendingleftposts.map((item, i) => (
                <div
                  key={i}
                  className="single-menu-box wow fadeInUp"
                ...
                >
                  ...
                  <div className="menu-desc">
                    ...
                    <p>{item.text}</p>
                    <Link to="/shop-detail" className="menu-link">
