                    ...
                    <div className="col-lg-8 col-md-10">
                        <div className="blog-loop">
                            <div className="post-box mb-40">
                                ...
                                <div className="post-desc">
                                    ...
                                    <ul className="post-meta">
                                        <li><Link to="/blog-detail"><i className="far fa-eye" />232 Views</Link></li>
                                        <li><Link to="/blog-detail"><i className="far fa-comments" />35 Comments</Link></li>
                                        <li><Link to="/blog-detail"><i className="far fa-calendar-alt" />24th March 2022</Link></li>
                                    </ul>
                                    ...
                                    <div className="post-footer">
                                        <div className="author">
                                            <Link to="/blog-detail">
                                                <img src={author} alt="" />by Hetmayar
                                            </Link>
                                        </div>
                                        <div className="read-more">
                                            <Link to="/blog-detail"><i className="far fa-arrow-right" />Read More</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="post-box with-video mb-40">
                                <div className="post-media">
                                    <img src={img2} alt="" />
                                    <Link to="/blog-detail" className="play-icon"><i className="fas fa-play" /></Link>
                                </div>
                                <div className="post-desc">
                                    <Link to="/blog-detail" className="cat">Businese</Link>
                                    <h2>
