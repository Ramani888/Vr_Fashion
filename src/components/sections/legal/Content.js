...
const popularfeeds = [
  {
    img: img1,
    title: "How Are Colored Diamonds Formed?",
    postdate: "24th March 2022",
  },
  {
    img: img2,
    title: "How Are Colored Diamonds Formed?",
          ...
          <div className="col-lg-8">
            <div className="legal-wrapper">
              <div className="legal-content">
                <h3>Who Are We</h3>
                <p>
                  Our website is: https://themeforest.net/user/metropolitantheme
                </p>
              </div>
              <div className="legal-content">
                  ...
                  {popularfeeds.map((item, i) => (
                    <div key={i} className="single-popular-feed">
                      ...
                      <div className="feed-desc">
                        ...
                        <span className="time">
                          <i className="far fa-calendar-alt" /> {item.postdate}
                        </span>
                      </div>
                    </div>
                  ))}
