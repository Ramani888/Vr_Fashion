      ...
      <div className="container">
        ...
        <div className="row features-loop">
          <div className="col-lg-4 col-sm-6 order-1">
            <div
              className="feature-box dark-box wow fadeInLeft"
              data-wow-delay=".3s"
            >
              <span className="count">01</span>
              <h3>
                <Link to="#">Get On Offer Price</Link>
              </h3>
              <p>
          ...
          <div className="col-lg-4 col-sm-6 order-2">
            <div
              className="feature-box dark-box wow fadeInDown"
              data-wow-delay=".4s"
            >
              <span className="count">02</span>
              <h3>
                <Link to="#">Quiet Hours Offer</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna..
          ...
          <div className="col-lg-4 col-sm-6 order-3 order-sm-4 order-lg-3">
            <div
              className="feature-box dark-box wow fadeInRight"
              data-wow-delay=".5s"
            >
              <span className="count">03</span>
              <h3>
                <Link to="#">Assured Quality</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna..
          ...
          <div className="col-lg-4 col-sm-6 order-4 order-sm-3 order-lg-4">
            ...
            >
              ...
              <h3>
                <Link to="#">Free Cancellation</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna..
          ...
          <div className="col-lg-4 col-sm-6 order-5">
            <div
              className="feature-box dark-box wow fadeInUp"
              data-wow-delay=".7s"
            >
          ...
          <div className="col-lg-4 col-sm-6 order-6">
            ...
            >
              ...
              <h3>
                <Link to="#">Online Special Offers</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna..
