...
// Masonary image
import msimg1 from "../../../assets/img/room-type/03.jpg";
import msimg2 from "../../../assets/img/room-type/01.jpg";
import msimg3 from "../../../assets/img/room-type/02.jpg";

const Onsale = () => {
  return (
    <section className="pt-115 pb-115 bg-white room-type-section style-2">
        ...
        <div className="row room-items">
          <div className="col-lg-6">
            <div className="room-box extra-height">
              <div
                className="room-bg"
                style={{ backgroundImage: "url(" + msimg1 + ")" }}
              ></div>
              <div className="room-content">
                <h3>
                  <Link to="/shop-detail">Ariel Ring</Link>
                </h3>
                <p>
              ...
              <Link to="/shop-detail" className="room-link">
            ...
            <div className="row">
              <div className="col-lg-12 col-md-6">
                <div className="room-box">
                  <div
                    className="room-bg"
                    style={{ backgroundImage: "url(" + msimg2 + ")" }}
                  ></div>
                  <div className="room-content">
                    <h3>
                      <Link to="/shop-detail">Agonfly Jewelry</Link>
                    </h3>
                    <p>
              ...
              <div className="col-lg-12 col-md-6">
                <div className="room-box">
                  <div
                    className="room-bg"
                    style={{ backgroundImage: "url(" + msimg3 + ")" }}
                  ></div>
                  <div className="room-content">
                    <h3>
                      <Link to="/shop-detail">Coin Gold Necklace</Link>
                    </h3>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur elit, sed do
                      eiusmod tempor incididunt ut labore magna aliqua.
